...
def home():
    ...
    <body style="font-family: Arial; text-align: center; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 50px;">
        <h1>File Host By @HARMANXKING</h1>
...
# --- Configuration ---
TOKEN = os.getenv('TELEGRAM_BOT_TOKEN','8345947714:AAF84RZVwKzJMbRHdbEpFJ65pGb-wTCtfQo')
OWNER_ID = int(os.getenv('OWNER_ID', '2052400282'))
ADMIN_ID = int(os.getenv('ADMIN_ID', '2052400282'))
YOUR_USERNAME = os.getenv('BOT_USERNAME', '@HARMANXKING')
UPDATE_CHANNEL = os.getenv('UPDATE_CHANNEL', 'https://t.me/HARMAN2BOSS')
